...
class productcomposer extends SeedObject
{
	/**
	 * Draft status
	 */
	...
	public $table_element = 'productcomposer';

	public $element = 'productcomposer';
...
//		global $user;
	...
	private function getNextNumero()
	{
		...
		$numero = get_next_value($db, $mask, 'productcomposer', 'ref');
...
//		global $user;
	...
	public function getNomUrl($withpicto=0, $get_params='')
	{
        ...
        $result='';
        $label = '<u>' . $langs->trans("Showproductcomposer") . '</u>';
	...
	public static function LibStatut($status, $mode)
	{
		...
		if ($status==self::STATUS_REFUSED) { $statustrans='statut5'; $keytrans='productcomposerStatusRefused'; $shortkeytrans='Refused'; }
		if ($status==self::STATUS_ACCEPTED) { $statustrans='statut6'; $keytrans='productcomposerStatusAccepted'; $shortkeytrans='Accepted'; }
...
/*
class productcomposerDet extends TObjetStd
{
	public $table_element = 'productcomposerdet';

	public $element = 'productcomposerdet';
