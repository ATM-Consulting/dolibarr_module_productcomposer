 ...
 */
class productcomposerbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "productcomposer@productcomposer";
    public $boxlabel;
    public $depends = array("productcomposer");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/productcomposer/class/productcomposer.class.php";
