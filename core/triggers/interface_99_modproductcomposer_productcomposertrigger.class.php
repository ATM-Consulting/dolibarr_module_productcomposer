...
/**
 * 	\file		core/triggers/interface_99_modMyodule_productcomposertrigger.class.php
 * 	\ingroup	productcomposer
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modProductcomposer_Mytrigger.class.php
 ...
 * Trigger class
 */
class Interfaceproductcomposertrigger
{
